...
?>
<?php
    $img_link = base_url()."/assets/images";
    $image_properties = array(
          'src' => $img_link.'/refresh.png',
          'class' => 'refresh',
          'title' => 'Refresh',
);
?>

<a href="#" class="refresh_view"><?php echo img($image_properties);?></a>
<br /><br />
<div class="fRight" style="margin: -45px 8px 0 0;">
    <button id="create-log">Add Produksi</button>
</div>
<div id="show">
    <?php $this->load->view('view/show'); ?>
</div>

<?php

$kebun = $this->view_model->get_kebun_all();
$options = "";
$options[''] = "- - Kebun - -";
